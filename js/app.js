        ...
        <div class="card bordered">
          ...
          <div class="card-body">
            <h2 class="card-title">${product.title}
              <div class="badge mx-2 badge-primary">${product.category}</div>
            </h2> 
            <h2 class="text-xl">Price: $ ${price.toFixed(2)}</h2>
            <h5>Rating: ${product.rating.rate}</h5>
            <h5>Rating Count: ${product.rating.count}</h5>
            <div class="justify-end card-actions">
              <button class="btn btn-primary" onclick="addToCart(${product.id},${product.price})" id="addToCart-btn">Add To Cart</button>
          </div>
